...
export const HeroParallax = ({
    ...
    return (
        <div
            ref={ref}
            className="h-[180vh] lg:h-[300vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-background"
        >
            <Header />
            <motion.div
                style={{
    ...
    return (
        <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 z-10 w-full left-0 top-0">
            ...
            <TextGenerateEffect
                ...
                words="Your ideas deserve more than just code. We blend cutting-edge technology with intuitive design to build websites and mobile applications that captivate users and convert visitors."
            />
        </div>
    );
};
