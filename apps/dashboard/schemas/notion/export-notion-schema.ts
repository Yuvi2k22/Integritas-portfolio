...
export const exportNotionSchema = z.object({
  ...
  notionProjectId: z
    .string({
      required_error: "Notion project id is required.",
      invalid_type_error: "Notion project id must be a string.",
    })
    .trim()
    .min(1, "Notion project id is required."),
});

export type ExportNotionSchema = z.infer<typeof exportNotionSchema>;
