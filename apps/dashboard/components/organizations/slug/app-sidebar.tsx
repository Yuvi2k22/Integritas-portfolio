...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-row flex-wrap items-center py-0">
        <div className="px-1 py-2">
          <Logo hideWordmark={state === 'collapsed' ? true : false} />
        </div>
      ...
      <SidebarContent className="overflow-hidden">
        ...
        >
          ...
          <NavSupport profile={profile} className="pb-0 mt-auto" />
        </ScrollArea>
      </SidebarContent>
